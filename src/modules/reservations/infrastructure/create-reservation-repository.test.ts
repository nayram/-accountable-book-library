...
describe('CreateReservationRepository', () => {
  describe('save', () => {
    it('should save reservation, wallet and book as a transaction', async () => {
      ...
      await createReservationRepository.save({ reservation, wallet: updatedWallet, book: updatedBook });
    ...
    it('should rollback the transaction if one operation fails', async () => {
      ...
      await expect(
        createReservationRepository.save({ reservation, wallet: updatedWallet, book: updatedBook }),
